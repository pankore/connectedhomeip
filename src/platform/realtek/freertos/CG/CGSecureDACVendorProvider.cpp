...
CHIP_ERROR CGSecureDACVendorProvider::GetCertificationDeclaration(MutableByteSpan & outBuffer)
{
    ...
    const uint8_t kCdForAllExamples[] = {
        ...
        0x01, 0x16, 0x13, 0x36, 0x02, 0x05, 0x25, 0x1a, 0x18, 0x24, 0x03, 0x16, 0x2c, 0x04, 0x13, 0x5a, 0x49, 0x47, 0x32, 0x30,
        0x31, 0x34, 0x32, 0x5a, 0x42, 0x33, 0x33, 0x30, 0x30, 0x30, 0x33, 0x2d, 0x32, 0x34, 0x24, 0x05, 0x00, 0x24, 0x06, 0x00,
        0x25, 0x07, 0x94, 0x26, 0x24, 0x08, 0x01, 0x18, 0x31, 0x7d, 0x30, 0x7b, 0x02, 0x01, 0x03, 0x80, 0x14, 0x62, 0xfa, 0x82,
        ...
        0x03, 0x02, 0x04, 0x47, 0x30, 0x45, 0x02, 0x20, 0x43, 0xa9, 0x95, 0xed, 0xbc, 0xaa, 0x0a, 0x4c, 0xaa, 0xa2, 0xb9, 0xaf,
        0xcc, 0x53, 0x93, 0xda, 0xef, 0xd3, 0x42, 0x45, 0x3d, 0xd9, 0x36, 0x4c, 0x82, 0x67, 0xbf, 0xe6, 0x9f, 0xc8, 0xec, 0xb7,
        0x02, 0x21, 0x00, 0xcc, 0xc1, 0x07, 0xa5, 0x8f, 0xa6, 0x8a, 0x00, 0x6e, 0xf6, 0xdf, 0xff, 0x0a, 0x10, 0x26, 0x02, 0x9f,
        0x4b, 0x71, 0x1b, 0x53, 0x79, 0xc6, 0x29, 0x44, 0x87, 0xe4, 0x9a, 0xd9, 0x71, 0x11, 0x81
    };
...
CHIP_ERROR CGSecureDACVendorProvider::SignWithDeviceAttestationKey(const ByteSpan & messageToSign, MutableByteSpan & outSignBuffer)
{
    ...
    int ret = SignData(CGCRYPTO_KEY_ID_DEVICE_KEY, CGCRYPTO_HASH_TYPE_SHA_256, messageToSign.data(), messageToSign.size(),
