...
class AmebaP256Keypair : public Crypto::P256Keypair
{
public:
    AmebaP256Keypair() {}
    ~AmebaP256Keypair() override;
...
protected:
    ...
    mutable Crypto::P256KeypairContext mKeypair;
 ...
 */
class AmebaPersistentStorageOperationalKeystore : public Crypto::OperationalKeystore
{
public:
    AmebaPersistentStorageOperationalKeystore() = default;
    virtual ~AmebaPersistentStorageOperationalKeystore() { Finish(); }

    // Non-copyable
    AmebaPersistentStorageOperationalKeystore(AmebaPersistentStorageOperationalKeystore const &) = delete;
    void operator=(AmebaPersistentStorageOperationalKeystore const &)                       = delete;
