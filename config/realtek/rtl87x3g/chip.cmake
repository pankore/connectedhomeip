...
list(
	...
	${inc_path}
    ${CHIP_ROOT}/config/realtek/rtl87x3g
    ${CHIP_ROOT}/src/include
    ${CHIP_ROOT}/src/lib
    ${CHIP_ROOT}/src
    ${CHIP_ROOT}/src/system
    ${CHIP_ROOT}/src/app
    ${CHIP_ROOT}/src/platform/realtek/RTL87X3G
...
set(import_str "import(\"//config/realtek/rtl87x3g/args.gni\")\n" )
...
string(APPEND CHIP_GN_ARGS "pw_sys_io_BACKEND = \"//examples/platform/realtek/rtl87x3g/pw_sys_io:pw_sys_io_bee\"\n")
...
ExternalProject_Add(
    ...
    CONFIGURE_COMMAND       gn
                            --root=${CHIP_ROOT}
                            --root-target=${CHIP_ROOT}/config/realtek/rtl87x3g
                            --dotfile=${CHIP_ROOT}/config/realtek/rtl87x3g/.gn
                            gen
                            --check
                            --fail-on-unused-args
                            "${CHIP_OUTPUT}"
    BUILD_COMMAND           ninja -C "${CHIP_OUTPUT}" rtl87x3g
    INSTALL_COMMAND         ""
