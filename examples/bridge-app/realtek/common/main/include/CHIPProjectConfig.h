...
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION 69
#endif
...
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION_STRING "69.0"
#endif
 ...
 *
 * Maximum number of bridged devices supported by the bridge app.
 * Set to 1 to support only 1 bridged device.
 */
