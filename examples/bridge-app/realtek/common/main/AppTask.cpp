...
// Forward declaration
extern void Sync_SubDevice_test();
 ...
 * Note: Bridge app uses dynamic endpoints - no local cluster state to update
 */
void AppTask::UpdateClusterState(void)
{
    ChipLogProgress(NotSpecified, "UpdateClusterState - Bridge app does not use local cluster state");
}
