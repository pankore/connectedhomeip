...
{
    // Bridge app: No local action needed for bridged device on/off
    // The bridged devices are handled by SubDeviceManager
    ChipLogProgress(Zcl, "emberAfOnOffClusterInitCallback for endpoint %d", endpoint);
}