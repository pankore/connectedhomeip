...
public:
    ...
    static inline StorageKeyName GetKeyDiagUserSupport() { return StorageKeyName::FromConst("realtek/diag/usr"); }

    static inline StorageKeyName GetKeyDiagNetwork() { return StorageKeyName::FromConst("realtek/diag/nwk"); }

    static inline StorageKeyName GetKeyDiagCrashLog() { return StorageKeyName::FromConst("realtek/diag/crash"); }
